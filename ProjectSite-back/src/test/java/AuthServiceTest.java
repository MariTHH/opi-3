...
public class AuthServiceTest {
    ...
    public void testAddParams() {
        ...
        User user = new User(login, "testPassword", null, null);
    ...
    public void testGetParams() {
        ...
        User user = new User(login, "testPassword", weight, sex);
        when(userRepository.findByLogin(login)).thenReturn(user);
    ...
    public void testCheck() {
        ...
        User user = new User(login, passwordHash, weight, sex);
        when(userRepository.findByLogin(login)).thenReturn(user);
    ...
    public void testCheckWithInvalidPassword() {
        ...
        User user = new User(login, authService.getHash("testPassword"), "1", "testSex");
        when(userRepository.findByLogin(login)).thenReturn(user);
